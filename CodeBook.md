...
### Section 1. Combine the training and the test sets to create one.
...
Combine data subset with the activityType table to cinlude the descriptive activity names
